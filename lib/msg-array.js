...
var MsgArray = /** @class */ (function (_super) {
    ...
    function MsgArray(value) {
        ...
        if (!value)
            value = [];
        var array = _this.array = [].map.call(value, function (item) { return msg_value_1.MsgValue.fromAny(item); });
...
var MsgFixArray = /** @class */ (function (_super) {
    ...
    MsgFixArray.parse = function (buffer, offset) {
...
var MsgArray16 = /** @class */ (function (_super) {
    ...
    MsgArray16.parse = function (buffer, offset) {
...
var MsgArray32 = /** @class */ (function (_super) {
    ...
    MsgArray32.parse = function (buffer, offset) {
...
function read(self, buffer, offset, start, length) {
    for (var i = 0; i < length; i++) {
        var msg = self.array[i] = msg_value_1.MsgValue.parse(buffer, start);
