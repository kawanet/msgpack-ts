...
var MsgMap = /** @class */ (function (_super) {
    ...
    function MsgMap(value) {
        ...
        Object.keys(value).forEach(function (key) {
            var val = msg_value_1.MsgValue.fromAny(value[key]);
            if (val)
                array.push(new msg_string_1.MsgString(key), val);
        });
...
var MsgFixMap = /** @class */ (function (_super) {
    ...
    MsgFixMap.parse = function (buffer, offset) {
...
var MsgMap16 = /** @class */ (function (_super) {
    ...
    MsgMap16.parse = function (buffer, offset) {
...
var MsgMap32 = /** @class */ (function (_super) {
    ...
    MsgMap32.parse = function (buffer, offset) {
...
function read(self, buffer, offset, start, length) {
    ...
    for (var i = 0; i < length; i++) {
        var key = msg_value_1.MsgValue.parse(buffer, start);
        start += key.msgpackLength;
        var val = msg_value_1.MsgValue.parse(buffer, start);
